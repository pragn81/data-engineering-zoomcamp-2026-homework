...
def create_events_aggregated_streak_sink(t_env):
    table_name = 'processed_events_aggregated_streak'
    sink_ddl = f"""
...
def log_aggregation():
    ...
    try:
        ...
        aggregated_table = create_events_aggregated_streak_sink(t_env)
